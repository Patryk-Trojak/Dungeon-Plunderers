...
void FirstMenuState::initButtons()
{
	...
	buttons.insert(std::pair< std::string, TextButton >("ExitButton", TextButton(sf::Vector2f(810, 800), sf::Vector2f(300, 70), stateData.resources[TextureID::GreyButton300x70], stateData.resources.font, L"WyjdŸ", 50, ContentAlignment::center)));
}
