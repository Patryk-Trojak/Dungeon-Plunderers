...
EnemyHealthBar::EnemyHealthBar(const sf::Vector2f& Position, const Resources& resources, const sf::Font& font,
	...
	:Bar(Position, resources[TextureID::EnemyHealthBarBackground], resources[TextureID::EnemyHealthBarHealth], font, InitialHp, InitialHp, sf::Vector2f(1.f, 1.f), 28, offset)
{
