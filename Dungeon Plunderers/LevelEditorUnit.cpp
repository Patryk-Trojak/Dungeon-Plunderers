...
void LevelEditorUnit::setHitboxesDependingOnType()
{
	...
	case LevelEditorUnitsNames::slimeEnemy:
		...
		break;
	case LevelEditorUnitsNames::zombieInGround:
		hitboxComponent.addHitbox(Hitbox(getUpperLeftCorner(), sf::Vector2f(44.f, 100.f), sf::Vector2f(-16.f, 4.f)));
		hitboxComponent.addHitbox(Hitbox(getUpperLeftCorner(), sf::Vector2f(20.f, 28.f), sf::Vector2f(-36.f, 76.f)));
		hitboxComponent.addHitbox(Hitbox(getUpperLeftCorner(), sf::Vector2f(24.f, 36.f), sf::Vector2f(28.f, 32.f)));
	...
	case LevelEditorUnitsNames::ghost:
		...
		break;
	case LevelEditorUnitsNames::bat:
		hitboxComponent.addHitbox(Hitbox(getUpperLeftCorner(), sf::Vector2f(50.f, 50.f), sf::Vector2f(-26.f, 78.f)));
		hitboxComponent.addHitbox(Hitbox(getUpperLeftCorner(), sf::Vector2f(64.f, 32.f), sf::Vector2f(-32.f, 48.f)));
		hitboxComponent.addHitbox(Hitbox(getUpperLeftCorner(), sf::Vector2f(50.f, 128.f), sf::Vector2f(-26.f, 0.f)));

		base.addHitbox(Hitbox(getUpperLeftCorner(), sf::Vector2f(12.f, 4.f), sf::Vector2f(-28.f, 156.f)));
		base.addHitbox(Hitbox(getUpperLeftCorner(), sf::Vector2f(12.f, 4.f), sf::Vector2f(12.f, 156.f)));
		base.addHitbox(Hitbox(getUpperLeftCorner(), sf::Vector2f(28.f, 4.f), sf::Vector2f(-16.f, 156.f)));

		break;
	case LevelEditorUnitsNames::spinningSpikes:
	case LevelEditorUnitsNames::movingSpinningSpikes:
		hitboxComponent.addHitbox(Hitbox(getUpperLeftCorner(), sf::Vector2f(150.f, 150.f), sf::Vector2f(-75.f, -75.f)));

		base.addHitbox(Hitbox(getUpperLeftCorner(), sf::Vector2f(12.f, 4.f), sf::Vector2f(-75.f, 100.f)));
		base.addHitbox(Hitbox(getUpperLeftCorner(), sf::Vector2f(12.f, 4.f), sf::Vector2f(63.f, 100.f)));
		base.addHitbox(Hitbox(getUpperLeftCorner(), sf::Vector2f(126.f, 4.f), sf::Vector2f(-63.f, 100.f)));
		break;
	case LevelEditorUnitsNames::player:
